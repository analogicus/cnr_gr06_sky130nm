...
C {devices/opin.sym} 980 -360 1 0 {name=p3 lab=I2
}
C {devices/opin.sym} 1010 -430 0 0 {name=p4 lab=I1}
C {devices/opin.sym} 1140 -660 0 0 {name=p5 lab=Vn
}
C {devices/opin.sym} 1470 -520 0 0 {name=p6 lab=Vcap
}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 1430 -440 0 1 {name=C3 model=cap_mim_m3_1 W=7 L=8 MF=25 spiceprefix=X}
C {sky130_fd_pr/res_high_po.sym} 1010 -400 0 0 {name=R1_0
W=5
L=0.1
model=res_high_po
mult=1}
C {devices/opin.sym} 940 -620 0 0 {name=p9 lab=Vh
}
C {devices/opin.sym} 940 -480 0 0 {name=p10 lab=Vl
}
