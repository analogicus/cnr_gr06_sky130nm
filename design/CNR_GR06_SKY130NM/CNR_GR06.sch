...
C {devices/lab_wire.sym} 330 -520 0 0 {name=p3 sig_type=std_logic lab=VCN}
C {sky130_fd_pr/pnp_05v5.sym} 690 -480 0 0 {name=Q1
...
model=res_high_po
mult=0.25}
C {sky130_fd_pr/pnp_05v5.sym} 310 -480 0 0 {name=Q2
model=pnp_05v5_W3p40L3p40
m=8
spiceprefix=X
}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 850 -500 0 1 {name=C1 model=cap_mim_m3_1 W=14 L=5 MF=25 spiceprefix=X}
C {sky130_fd_pr/nfet_01v8.sym} 1000 -480 0 1 {name=M24
L=1
W=3.8
nf=1
mult=1
...
C {devices/lab_wire.sym} 1030 -480 0 1 {name=p20 sig_type=std_logic lab=Vout}
